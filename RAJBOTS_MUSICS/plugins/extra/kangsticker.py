...
from SIMPLE_MUSIC.utils.errors import capture_err

from SIMPLE_MUSIC.utils.files import (
    get_document_from_file_id,
    resize_file_to_sticker_size,
    upload_document,
)

from SIMPLE_MUSIC.utils.stickerset import (
    add_sticker_to_set,
    create_sticker,
    create_sticker_set,
...
#-------
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="Start", url=f"t.me/{BOT_USERNAME}", **_get_style(r1))]]
        )
        await msg.edit(
